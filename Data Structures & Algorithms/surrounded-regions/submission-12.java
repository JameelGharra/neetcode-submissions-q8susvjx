class Solution {
    // this is standard thinking no reverse dfs or thinking
    // this can have many bugs, look at the conditions
    // it is still O(m * n) time and space but still..
    ...
    private boolean dfs(char[][]board, int r, int c, List<int[]> group) {
